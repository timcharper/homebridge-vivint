...
function DeviceSetModule(config, log, homebridge, vivintApi) {
  ...
  let config_debug = config.debug || false
  ...
  class DeviceSet {
    ...
    handleMessage(message) {
      if (this.config_debug) log.debug(message)
      if (message.Data) {
  ...
  class Camera extends Device {
    ...
    notify() {
      if (this.service) {
        ...
        if (this.config_debug) log.debug(`Updated camera motion PIV: ${this.getMotionDetectedState()}`)
      }
    }
  }
  extend(Camera, {
  ...
  class MotionSensor extends Device {
    ...
    notify() {
      ...
      if (this.batteryService) {
        this.batteryService
          .updateCharacteristic(Characteristic.StatusLowBattery, 
