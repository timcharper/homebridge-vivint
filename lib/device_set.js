...
function DeviceSetModule(config, log, homebridge, vivintApi, ThermostatCharacteristics, setInterval, Date) {
  ...
  let config_IgnoredDeviceClasses = config.ignoreDeviceClass || []
  ...
  class DeviceSet {
    ...
    bindAccessory(accessory) {
      ...
      if (config_IgnoredDeviceClasses != undefined && config_IgnoredDeviceClasses.indexOf(accessory.context.deviceClassName) != -1) {
        throw "Ignored device " + accessory.context.deviceClassName
      }
