    ...
    notify() {
      if (this.contactBatteryLevelValue()) {
	      if (0 <= this.contactBatteryLevelValue() && this.contactBatteryLevelValue() <= 10) {
		      this.service.getCharacteristic(Characteristic.StatusLowBattery).updateValue(Characteristic.StatusLowBattery.BATTERY_LEVEL_LOW)
		  }
		  else this.service.getCharacteristic(Characteristic.StatusLowBattery).updateValue(Characteristic.StatusLowBattery.BATTERY_LEVEL_NORMAL)
      }	  
