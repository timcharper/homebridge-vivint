...
class Camera extends Device {
    constructor(accessory, data, config, log, homebridge, vivintApi) {
      ...
      // if (accessory.getService(this.Service.Doorbell)) {
      //   this.doorBellService = accessory.getService(this.Service.Doorbell)
      //   this.doorBellService
      //       .getCharacteristic(this.Characteristic.ProgrammableSwitchEvent)
      //       .on('get', callback => callback(null, service.getCharacteristic(this.Characteristic.ProgrammableSwitchEvent).value))
      // }
    ...
    getMotionDetectedState() {
      let motionDetected = Boolean(this.data.PersonInView) || Boolean(this.data.VisitorDetected)
    ...
    async notify() {
      if (this.motionService) {
        ...
        if (motionDetected) {
          this.service.updateCharacteristic(this.Characteristic.MotionDetected, true);
          setTimeout(() => {
      ...
      if (this.controller.doorbellService && this.getDoorbellButtonPress()){
    ...
    static addServices(accessory, Service) {
      ...
      //   accessory.addService(new Service.Doorbell(accessory.context.name))
      // }
    }
  }
