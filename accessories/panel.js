...
const VivintDict = require("../lib/vivint_dictionary.json")
...
class Panel extends Device {
    ...
    async getTargetState(callback) {
      return callback(null, this.service.getCharacteristic(this.Characteristic.SecuritySystemTargetState));
    }
      ...
      if (this.service) {
        ...
        if (state !== undefined) {
          this.service
            ...
            .updateCharacteristic(this.Characteristic.SecuritySystemTargetState, state) //TODO: Check how it behaves during alarm
        }
      }
    }
